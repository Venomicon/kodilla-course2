...
public class Watcher {
    ...
    public  void logOrderProcess() {
        LOGGER.info("An order process has been initialised");
    }


    @Around("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processOrder(..))")
    public Object measureTimeOfOrderProcess(final ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        Object result;
        try {
            long begin = System.currentTimeMillis();
            result = proceedingJoinPoint.proceed();
            ...
            LOGGER.error("Time measurement impossible: " + throwable.getMessage());
            throw throwable;
        }
        return result;
    }
